...
class DigitransitFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            try:
                ...
                self.data = {"digitransit_api_key": user_input["digitransit_api_key"]}
    ...
    async def identify_stop(self, search_term, data_region):
    ...
    async def _search_for_stop(self, search_term: str) -> dict:
        ...
        return await self.hass.async_add_executor_job(client.search, "hsl", search_term)
